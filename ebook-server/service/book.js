...
function clearUploadDir() {
    fs.rmdirSync(`${UPLOAD_PATH}/book`, {
        recursive: true
    })
    fs.rmdirSync(`${UPLOAD_PATH}/img`, {
        recursive: true
    })
    fs.rmdirSync(`${UPLOAD_PATH}/unzip`, {
        recursive: true
    })
}
